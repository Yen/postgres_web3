...
Datum uint256_as_int2(PG_FUNCTION_ARGS)
{
    ...
    if (*value > (pw3_uint256)PG_INT16_MAX)
    {
...
{
    pw3_uint256 *value = PW3_GETARG_UINT256_P(0);
    if (*value > (pw3_uint256)PG_INT32_MAX)
    {
...
{
    pw3_uint256 *value = PW3_GETARG_UINT256_P(0);
    if (*value > (pw3_uint256)PG_INT64_MAX)
    {
...
PG_FUNCTION_INFO_V1(uint256_as_hex160);
Datum uint256_as_hex160(PG_FUNCTION_ARGS)
{
    pw3_uint256 *value = PW3_GETARG_UINT256_P(0);
    if (*value > (pw3_uint256)PW3_HEX160_MAX)
    {
...
PG_FUNCTION_INFO_V1(uint256_as_hex256);
Datum uint256_as_hex256(PG_FUNCTION_ARGS)
{
    pw3_uint256 *value = PW3_GETARG_UINT256_P(0);
