...
{
    pw3_uint128 *value = PW3_GETARG_UINT128_P(0);
    if (*value > (pw3_uint128)PW3_INT128_MAX)
    {
...
PG_FUNCTION_INFO_V1(uint128_as_int256);
Datum uint128_as_int256(PG_FUNCTION_ARGS)
{
    pw3_uint128 *value = PW3_GETARG_UINT128_P(0);
    PW3_RETURN_INT256_P(pw3_int256_palloc(*value));
}

PG_FUNCTION_INFO_V1(uint128_as_uint256);
Datum uint128_as_uint256(PG_FUNCTION_ARGS)
{
    pw3_uint128 *value = PW3_GETARG_UINT128_P(0);
